...
const char *esweep_type(const esweep_object *obj) { /* TEST: OK */
	ESWEEP_OBJ_ISVALID(obj, NULL);
...
int esweep_samplerate(const esweep_object *obj) { /* TEST: OK */ 
...
int esweep_size(const esweep_object *obj) { /* TEST: OK */
	ESWEEP_OBJ_ISVALID(obj, ERR_OBJ_NOT_VALID);
	return obj->size;
}
