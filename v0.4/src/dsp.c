...
void dsp_convolve(Complex *signal, Complex *kernel, Complex *table, long size) {
	int i;
	double t_real, t_imag; /* temp variables */
...
void dsp_deconvolve(Complex *signal, Complex *kernel, Complex *table, long size) { 
	int i;
	double t_real, t_imag; /* temp variables */
	double t_abs;
...
void dsp_hilbert(Complex *signal, Complex *table, long size) {
	long i, herm_size=size/2;
	double tmp;
...
void dsp_unwrapPhase(Polar *polar, long size) {
	long i, k;
	double tmp;
	tmp=polar[0].arg;
...
void dsp_wrapPhase(Polar *polar, long size) {
	long i, k;
